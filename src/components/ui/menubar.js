...
import { cn } from "../lib/utils"; // Adjust this path if your structure differs
...
const MenubarTrigger = forwardRef((props, ref) => {
  return (
...
const MenubarSubContent = forwardRef((props, ref) => {
  return (
...
const MenubarSeparator = forwardRef((props, ref) => {
  return (
